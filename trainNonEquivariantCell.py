...
def main(args):
    ...
    model = UnetVariant(img_channels=args.imgChannel, out_channels=args.outputChannel, in_channels=args.inputChannel).to(device)
    ...
    # save losses to csv
    loss_dir = os.path.join('output', f"lr{str(lr)}", 'non_equiv0', 'losses.txt')
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train non-equivariant U-Net')
